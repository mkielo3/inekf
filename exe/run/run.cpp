...
//             R_result.block<3,3>(3*i,0) = state[0];
//             // save v in local frame
//             v_result.row(i) = (state[0].transpose() * state[1]).transpose();
//             p_result.row(i) = state[2].transpose();
//             i += 1;
//             std::cout << state.getAugment() << std::endl;
//         }
